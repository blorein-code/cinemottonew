...
export default function CertificateViewPage() {
  ...
  const shareOnTwitter = () => {
    const text = `Film Replikleri Testini ${score} puan ile tamamladım! 🎬 #Cinemottos`;
  ...
  const shareOnInstagram = () => {
    // Instagram API direkt paylaşıma izin vermediği için web sitesine yönlendirelim
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-6 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="p-3 space-y-4">
          ...
          {/* İndirme ve Ana Sayfa Butonları */}
          <div className="flex justify-center gap-4">
            <button
